...
OpenLayers.Renderer.VML = OpenLayers.Class(OpenLayers.Renderer.Elements, {
    ...
    drawTextOLD: function(featureId, style, location) {
		...
		// if (style.angle || style.angle == 0) {        
        	...
        	// textbox.style.angle = 'rotate:' + style.angle;
        // }
...
// 
 ...
 //############################### Rotate
        ...
        // var geometry = feature.geometry; //das ist ein Punkt und daher ist die geometry nur ein punkt, daher funktioniert die for unten nicht. Was tun?
