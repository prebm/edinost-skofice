...
function init(){
	...
	var cluster = {
    	context:{
    		...
    		GEONAME_MA: function(feature) { 
    			...
    			feature.attributes.FeatureID = feature.cluster[0].attributes.FeatureID
    		...
    		FeatureID: function(feature) {
				return feature.attributes.FeatureID; 
			}
	...
	vasi = new OpenLayers.Layer.Vector("vasi", {
   	...
   	map.addLayers([cerkve, tericne, mlini, krizi_na, krizi, vrhovi_na, vrhovi, kmetijePod_na, kmetijePod, 
   							kmetije_na, kmetije, ledine_na, ledine, krajine_na, krajine, vasi_na, vasi]);
	...
	map.setCenter(new OpenLayers.LonLat(1584428, 5870741),13);
...
function onFeatureSelect(evt) {
    feature = evt.feature;
    if (feature.attributes.info_html == undefined){
    feature.attributes.info_html="";}
    popup = new OpenLayers.Popup.FramedCloud("featurePopup",
                             feature.geometry.getBounds().getCenterLonLat(),
                             new OpenLayers.Size(100,100),
                             "<h3>"+feature.attributes.GEONAME_MA + " ID: "+feature.attributes.FeatureID+"</h3>"+feature.attributes.info_html+
                             			"<hr/><audio controls='controls' autoplay='autoplay'><source src='"+
                             			feature.attributes.link+"ogg' type='audio/ogg' /><source src='"+feature.attributes.link+
                             			"mp3' type='audio/mp3' />Your browser does not support the audio tag.</audio>", //TODO: string in eine Variable stecken
